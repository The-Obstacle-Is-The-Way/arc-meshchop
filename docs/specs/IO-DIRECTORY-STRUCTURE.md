...
```bash
uv run arc-meshchop export --checkpoint experiments/fold_0_restart_5/final.pt --output exports/
```
...
### Export Model
```bash
uv run arc-meshchop export \
    --checkpoint experiments/fold_0_restart_5/final.pt \
    --output exports/
```
